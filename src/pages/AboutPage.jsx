  ...
  return (
    <div className="min-h-screen pt-24 pb-20">
      <div className="mx-auto max-w-5xl px-6 sm:px-10">
        ...
        {/* ── Bio statement card ──────────────────── */}
        <motion.div {...up(0.1)} className="section-card mb-6">
        ...
        <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <motion.div {...up(0.25)} className="section-card">
        ...
        {/* ── Tech Stack ──────────────────────────── */}
        <motion.div {...up(0.1)} className="mb-12">
        ...
        <motion.div {...up(0.1)}>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            {CERTIFICATES.map((c, i) => (
              <motion.div key={c.id} {...up(0.1 + i * 0.08)} className="section-card flex flex-col gap-3">
                ...
                <div>
                  ...
                  <h3 className="mt-0.5 font-mono text-sm font-bold text-[#e0e0e0]">{c.title}</h3>
                </div>
                <p className="font-mono text-xs leading-relaxed text-[#808080]">{c.description}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
